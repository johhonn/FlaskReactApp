...
var MonthPickerBody = _react2['default'].createClass({
  ...
  render: function render() {
    ...
    var months = _moment2['default'].months().map(function (_, index) {
    ...
    var rows = _lodashRange2['default'](nRows).map(function (index) {
      return _react2['default'].createElement(_Row2['default'], { pickers: months.slice(nColumns * index, nColumns * (index + 1)),
        mode: _this.props.mode,
        key: index
      });
    });
